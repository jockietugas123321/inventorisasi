...
<?php
// Path root web
$baseUrl = '/inventorisasi';
?>
<aside class="sidebar">
    <div class="sidebar-header">Dashboard Admin</div>
    <div class="sidebar-logo">
        <img src="<?= $baseUrl ?>/assets/images/logo.png" alt="Logo Inventarisasi">
    </div>
    <nav>
        <a href="<?= $baseUrl ?>/admin/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/index.php') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= $baseUrl ?>/admin/pegawai/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/pegawai') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= $baseUrl ?>/admin/kategori/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/kategori') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= $baseUrl ?>/admin/barang/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/barang') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= $baseUrl ?>/admin/manajemen/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/manajemen') !== false) ? 'active' : '' ?>">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 3h18v4H3z"/><path d="M3 9h18v4H3z"/><path d="M3 15h18v4H3z"/></svg> Manajemen Aset
        </a>
        <a href="<?= $baseUrl ?>/admin/stockopname/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/stockopname') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= $baseUrl ?>/admin/laporan/index.php" class="<?= (strpos($_SERVER['REQUEST_URI'], '/admin/laporan') !== false) ? 'active' : '' ?>">
